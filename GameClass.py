...
class Game:
    ...
    def draw(self):
        ...
        self.draw_text('Score: ' + str(self.score), 30, BLUE, 390, 10)
    ...
    def load_level(self, level):
        ...
        temp = enemy(ENEMY_START_POS, ENEMY_TEXTURE_SIZE, ENEMY_TEXTURES_NAMES, (ENEMY_NUM_TEXTURE_WALK, ENEMY_TEXTURE_SCALE, ENEMY_ANIMATION_DELAY), ENEMY_HEALTH, 1200)
        ...
        for row in level:
            ...
            for tile in row:
                if tile == 1 or tile == 2:
                    ...
                    p = StaticTextureObject((x, y), (PLATFORM_WIDTH, PLATFORM_HEIGHT), PLATFORM_IMAGE)
